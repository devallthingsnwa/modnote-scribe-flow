    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-medium text-white">Documents (Word, Text, PDF)</h3>
        </div>
        <div className="border-2 border-dashed border-[#333] rounded-lg p-6 text-center hover:border-[#444] transition-colors bg-[#151515]/50 relative">
          ...
          <div className="space-y-2">
            <p className="text-sm text-white">Upload Word, Text, or PDF documents</p>
            <p className="text-xs text-gray-400">Supports: DOCX, DOC, TXT, PDF files</p>
          </div>
          <input
            type="file"
